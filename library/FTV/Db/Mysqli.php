    ...
    class Ftv_Db_Mysqli
    {
        ...
        public function connect($host, $user, $paswd, $db, $port = self::DEFAULT_PORT)
        {
            ...
            if(0 !== mysqli_connect_errno($this->conn)) {
                throw new FTV_Exception(mysqli_connect_error($this->conn));
            }
            return $res;
        }
         ...
         * @throws FTV_Exception
         * @return void
         */
        protected function throwConnectException()
        {
            throw new FTV_Exception($this->conn->connect_error);
        }
        ...
        public function query($sql)
        {
            ...
            if(!$res) {
                throw new FTV_Exception($this->conn->error);
            }
            return $res;
        }
