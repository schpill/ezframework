<?php
     ...
     */
    class FTV_Environment implements ArrayAccess, IteratorAggregate
    {
        /**
         * @var array
         */
         ...
         * variables by using `FTV_Environment::mock()` instead.
         *
         * @param  bool             $refresh Refresh properties using global server variables?
         * @return FTV_Environment
         */
        ...
        public static function mock($userSettings = array())
        {
            self::$environment = new self(array_merge(array(
                ...
                'USER_AGENT' => 'FTV Framework',
                'REMOTE_ADDR' => '127.0.0.1',
                'FTV.url_scheme' => 'http',
                'FTV.input' => '',
                'FTV.errors' => @fopen('php://stderr', 'w')
            ), $userSettings));
        ...
        private function __construct($settings = null)
        {
            if ($settings) {
                ...
                if (strpos($_SERVER['REQUEST_URI'], $_SERVER['SCRIPT_NAME']) === 0) {
                    ...
                    $env['SCRIPT_NAME'] = repl('\\', '/', dirname($_SERVER['SCRIPT_NAME']) ); //With URL rewrite
                }
                ...
                $env['FTV.url_scheme'] = empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] === 'off' ? 'http' : 'https';
                ...
                $env['FTV.input'] = $rawInput;

                //Error stream
                $env['FTV.errors'] = fopen('php://stderr', 'w');
