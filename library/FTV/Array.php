<?php
    ...
    class FTV_Array
    {
         ...
         *
         *     // Returns TRUE
         *     FTV_Array::is_assoc(array('username' => 'john.doe'));
         *
         *     // Returns false
         *     FTV_Array::is_assoc('foo', 'bar');
         *
         ...
         *
         *     // Returns TRUE
         *     FTV_Array::is_array(array());
         *     FTV_Array::is_array(new ArrayObject);
         *
         *     // Returns false
         *     FTV_Array::is_array(false);
         *     FTV_Array::is_array('not an array!');
         *     FTV_Array::is_array(FTV_Model::instance());
         *
         ...
         *     $value = FTV_Array::path($array, 'foo.bar');
         *
         * Using a wildcard "*" will search intermediate arrays and return an array.
         *
         *     // Get the values of "color" in theme
         *     $colors = FTV_Array::path($array, 'theme.*.color');
         *
         *     // Using an array of keys
         *     $colors = FTV_Array::path($array, array('theme', '*', 'color'));
         *
        ...
        public static function path($array, $path, $default = null, $delimiter = null)
        {
            ...
            do {
                ...
                if (isset($array[$key])) {
                    if ($keys) {
                        if (FTV_Array::is_array($array[$key])) {
                    ...
                    foreach ($array as $arr) {
                        if ($value = FTV_Array::path($arr, implode('.', $keys))) {
                            $values[] = $value;
                        }
                    }
        ...
        */
         ...
         *     $username = FTV_Array::get($_POST, 'username');
         *
         *     // Get the value "sorting" from $_GET, if it exists
         *     $sorting = FTV_Array::get($_GET, 'sorting');
         *
         ...
         *     $auth = FTV_Array::extract($_POST, array('username', 'password'));
         *
         *     // Get the value "level1.level2a" from $data
         *     $data = array('level1' => array('level2a' => 'value 1', 'level2b' => 'value 2'));
         *     FTV_Array::extract($data, array('level1.level2a', 'password'));
         *
         ...
         *     FTV_Array::unshift($array, 'none', 'Select a value');
         *
         ...
         *     $array = FTV_Array::map('strip_tags', $array);
         *
         *     // Apply $this->filter to every element in the array
         *     $array = FTV_Array::map(array(array($this,'filter')), $array);
         *
         *     // Apply strip_tags and $this->filter to every element
         *     $array = FTV_Array::map(array('strip_tags',array($this,'filter')), $array);
         *
         * [!!] Because you can pass an array of callbacks, if you wish to use an array-form callback
         * you must nest it in an additional array as above. Calling FTV_Array::map(array($this,'filter'), $array)
         * will cause an error.
         ...
         *     $john = FTV_Array::merge($john, $mary);
         *
         ...
         *     $array = FTV_Array::overwrite($a1, $a2);
         *
         ...
         *     list($func, $params) = FTV_Array::callback('Foo::bar(apple,orange)');
         *
