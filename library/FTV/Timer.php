<?php
    ...
    class FTV_Timer
    {
        ...
        private static function _pushTime($cmd)
        {
            ...
            if ($cmd == self::CMD_START) {
                ...
                if (self::$_running === true) {
                    FTVLog('Timer has already been started');
                    return;
                }
                ...
                if (self::$_running === false) {
                    FTVLog('Timer has already been stopped/paused or has not yet been started');
                    return;
                }
                ...
                FTVLog('Invalid command specified');
                return;
            }
        ...
        public static function get($format = self::SECONDS)
        {
            ...
            if (self::$_running === true) {
                FTVLog('Forcing timer to stop', E_USER_NOTICE);
                self::stop();
            }
