<?php
    ...
    class FTV_Inflector
    {
        ...
        public static function underscore($word)
        {
            ...
            return self::$_underscored[$word] = strtolower(self::slug($word, '_'));
        }
        ...
        public static function humanize($word, $separator = '_')
        {
            ...
            return self::$_humanized[$key] = ucwords(str_replace($separator, " ", $word));
        }
        ...
        {
            if (null !== FTV_Utils::get('FTVConfig')) {
                $config = FTV_Utils::get('FTVConfig');
                return (null !== $config) ? $config['app']['encoding'] : 'utf-8';
            }
            return 'utf-8';
        }
