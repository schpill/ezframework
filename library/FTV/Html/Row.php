<?php
     ...
     */
    class FTV_Html_Row implements IteratorAggregate, Countable, ArrayAccess
    {
        ...
        *
        * @param string|FTV_Html_Cell $cell
        * @param array $attributes
        */
        public function add($value, array $attributes = null)
        {
            $cell = $value;
            if (is_string($value)) {
                $cell = new FTV_Html_Cell($value, $attributes);
            }
        ...
        */
        public function setState($state = null)
        {
            ...
            if (in_array($state, array(self::STATE_SUCCESS, self::STATE_ERROR, self::STATE_INFO))) {
                $this->_state = $state;
            }
        ...
        */
        public function __toString()
        {
            ...
            return sprintf('<tr%s>%s</tr>', FTV_Html::attributes($attributes), $content);
        }
    }
