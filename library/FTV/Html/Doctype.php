<?php
    class FTV_Html_Doctype
    {
         ...
         * @var string
         */
        protected $_regKey = 'FTV_Html_Doctype';
        ...
        {
            if (!FTV_Registry::has($this->_regKey)) {
                ...
                FTV_Registry::set($this->_regKey, $this->_registry);
                $this->setDoctype($this->_defaultDoctype);
            } else {
                $this->_registry = FTV_Registry::get($this->_regKey);
            }
        }
                ...
                switch ($doctype) {
                    ...
                    default:
                        if (substr($doctype, 0, 9) != '<!DOCTYPE') {
                            $e = new FTV_Exception('The specified doctype is malformed');
                            throw $e;
                        }
