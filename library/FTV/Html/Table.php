<?php
     ...
     */
    class FTV_Html_Table implements Iterator, Countable
    {
        /**
        * @var array
        */
        ...
        */
        public function row()
        {
            return new FTV_Html_Row();
        }

        /**
        * Adds a new row to the rows list
        *
        * @param FTV_Html_Row $row
        */
        public function add(FTV_Html_Row $row)
        {
            $this->_rows[] = $row;
        }
        ...
        * @param string $header
        */
        public function setHeader(FTV_Html_Row $tableHeader)
        {
        ...
        */
        public function __toString()
        {
            ...
            if (null !== $this->_caption) {
                $content .= sprintf('<caption>%s</caption>', FTV_Html::escape($this->_caption));
            }
            ...
            return sprintf('<table%s>%s</table>', FTV_Html::attributes($attributes), $content);
        }
    }
