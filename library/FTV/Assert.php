<?php
    ...
    final class FTV_Assert
    {
        ...
        {
            $checkArray = self::isArray($variable);
            if (false === $checkArray) {
                return false;
            }
        ...
        {
            $checkInteger = self::checkInteger($variable);
        ...
        {
            return self::checkFloat($variable);
        }
