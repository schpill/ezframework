<?php 
    ...
    class FTV_Message
    {
         ...
         *      $message->add('email', 'The e-mail address is invalid.');
         * </code>
         *
         * @param  string  $key
        ...
        {
            return !array_key_exists($key, $this->messages) || !in_array($message, $this->messages[$key]);
        }
         ...
         *      $message->format('email', '<p>this is my :message</p>');
         * </code>
         *
         * @param  string  $format
         */
         ...
         *      echo $message->get('email', '<p>:message</p>');
         * </code>
         *
         * @param  string  $key
         * @param  string  $format
